...
namespace polynomial {
    ...
    template<int64_t MOD, int64_t G> struct polynomial : protected std::vector<int> {
    ...
    template<int64_t MOD, int64_t G> auto operator+(int64_t x, polynomial<MOD, G> p) {
        p += x;
        return p;
    }
    template<int64_t MOD, int64_t G> auto operator+(polynomial<MOD, G> p, int64_t x) {
        p += x;
        return p;
    }
    template<int64_t MOD, int64_t G> auto operator-(polynomial<MOD, G> p, int64_t x) {
    ...
    template<int64_t MOD, int64_t G>
    auto operator*(polynomial<MOD, G> lhs, polynomial<MOD, G> rhs) {
    ...
    template<int64_t MOD, int64_t G> auto log(const polynomial<MOD, G> &p) {
    ...
    template<int64_t MOD, int64_t G> auto pow(const polynomial<MOD, G> &p, int64_t k) {
        return exp(log(p) * k);
    }
    ...
    auto eva_work(
        ...
        size_t mid = (l + r) >> 1;
        auto helper = [](const polynomial<MOD, G> &f, const polynomial<MOD, G> &g) {
